...
class DamageCalculator:
    ...
    def physical_damage(self, is_critical: bool) -> int:
        base_damage = self._attacker.attack
        damage_dealt = base_damage + (base_damage * self._physical_combat_advantage() / 8) - self._base_defense()
    ...
    def spell_damage(self) -> int:
        ...
        base_damage = (spell.base_damage + spell.level) * 2
    ...
    def _physical_combat_advantage(self):
